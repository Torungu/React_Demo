...
const RenderShoes = () => {
    ...
    function render(){
        return arrShoe.map((item,index)=>{
            return <div className="renderShoes_item space-y-3">
                <img src={item.image} alt="" />
                <h3 className='font-bold text-title capitalize'>{item.name}</h3>
                <p  className='text-[25px] font-medium text-green-700'>{item.price} $</p>
                <button className='px-5 py-2 bg-blue-500 rounded-lg'>Buy Now</button>
            </div>
        })
    }
    return (
        ...
        <div>
            <div className="container">
                <div className="grid grid-cols-4 gap-3">
                    {/* <div className="renderShoes_item space-y-3">
                        <img src={arrShoe[0].image} alt="" />
                        <h3 className='font-bold text-xl capitalize'>{arrShoe[0].name}</h3>
                        <p  className='text-lg font-medium text-green-700'>{arrShoe[0].price} $</p>
                        <button className='px-5 py-2 bg-blue-500 rounded-lg'>Buy Now</button>
                    </div> */}
                    {render()}
                </div>
